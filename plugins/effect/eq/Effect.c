...
void ReadEqData(uint8 *p, uint32 off, uint32 size)
{
    ...
    //printf("ReadEqData .....\n");
    page_addr = (uint32)stCodeInfo.CodeLoadBase;
...
int32_t EffectAdjust(RKEffect *userEQ, void *eqArg, uint32 sampleRate)
{
    ...
    case EQ_NOR:
    {
        ...
        {
        case 1:
            rkpm_remove_freq_scene(FREQ_EQ_L);
            EQ_FR_FLAG = 0;
            break;
        case 2:
            rkpm_remove_freq_scene(FREQ_EQ);
            EQ_FR_FLAG = 0;
            break;
        case 3:
            rkpm_remove_freq_scene(FREQ_EQ_H);
            EQ_FR_FLAG = 0;
            break;
        case 0:
            break;
